...
#include <iostream>
 ...
 void MenuFactory::create_everything() {
    a.WatchMorzeButton = new Button();
    std::cout<<"*";
    CreateMorzeButton(WatchMorzeButton);
    std::cout<<"*";
    Button* ToLevelListButton = new Button();
    CreateToLevelListButton(ToLevelListButton);
    Label* Label0 = new Label();
    Label* LabelMorze = new Label();
    CreateLabel(Label0);
    CreateLabelMorze(LabelMorze);
}
